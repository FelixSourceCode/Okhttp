 ...
 *     as {@link PathClassLoader} instead. <b>This API will be removed
...
public final class DexFile {
   ...
   */
     ...
     * @throws FileNotFoundException if fileName is not readable,
     *         not a file, or not present.
     * @throws IOException if fileName is not a valid apk/jar file or
